function loadTestimonials() {
    ...
    axios.get('./assets/js/reviews.json')
        .then(function (response) {
            ...
            const reviewsHTML = reviews
                .map(review => `
                    <a href="${review.reviewUrl}" target="_blank" class="testimonial-link">
                        <div class="testimonial-card">
                            <div class="testimonial-content">
                                ...
                                <div class="testimonial-header">
                                    <img src="${review.reviewerPhotoUrl}" alt="${review.name}" class="reviewer-photo">
